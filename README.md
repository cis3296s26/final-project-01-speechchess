...
4. Enter: python -m pip install chess SpeechRecognition sounddevice numpy pyttsx3 pygame jinja2 uvicorn[standard] fastapi sqlmodel "pwdlib[argon2]" python-multipart itsdangerous websockets
6. Navigate to directory where the extracted folder for this project is located
7. Enter: python -m uvicorn main:app --reload
8. Proceed to the link generated
...
2. Download python
3. Open Windows PowerShell
4. Enter: python -m pip install chess SpeechRecognition sounddevice numpy pyttsx3 pygame jinja2 uvicorn fastapi sqlmodel "pwdlib[argon2]" python-multipart itsdangerous websockets
...
2. Download python
3. Open Windows PowerShell
4. Enter: python -m pip install chess SpeechRecognition sounddevice numpy pyttsx3 jinja2 uvicorn fastapi sqlmodel "pwdlib[argon2]" python-multipart itsdangerous websockets
5. Navigate to directory where the extracted folder for this project is located
6. Enter: python -m uvicorn main:app --reload or python main.py
7. Proceed to the link generated
